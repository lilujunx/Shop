 ...
 */
public class RecordEvaFragment extends SCBaseFragment{
    ...
    public void initViews() {
        ...
        if (Constant.mWeiPingJia.size() == 0) {
            ...
            mItemLvRecordAdapter = new ItemLvRecordAdapter(mActivitySelf, Constant.mWeiPingJia);
