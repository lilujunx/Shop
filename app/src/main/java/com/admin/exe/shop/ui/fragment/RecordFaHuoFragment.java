 ...
 */
public class RecordFaHuoFragment extends SCBaseFragment{
    ...
    public void initViews() {
        ...
        if (Constant.mWeiFa.size() == 0) {
            ...
            mItemLvRecordAdapter = new ItemLvRecordAdapter(mActivitySelf, Constant.mWeiFa);
