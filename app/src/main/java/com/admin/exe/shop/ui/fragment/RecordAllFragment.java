 ...
 */
public class RecordAllFragment extends SCBaseFragment {
    ...
    public void initViews() {
        ...
        if (Constant.mAllRecord.size() == 0) {
            ...
            mItemLvRecordAdapter = new ItemLvRecordAdapter(mActivitySelf, Constant.mAllRecord);
